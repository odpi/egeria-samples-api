...
/**
 * GovernanceDomainSample calls each of the samples from a main program.  It is used to load all of the metadata created
 * by the samples in a single run.
 */
public class GovernanceDomainSample extends SampleBase
{
    /**
     * Run the samples.
     *
    ...
    public static void main(String[] args)
    {
        ...
        try
        {
            ...
            GovernanceDomainSample samplesSuite = new GovernanceDomainSample();
